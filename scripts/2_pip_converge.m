...
% Threshold proportion is controlled by THRESH_PROP. Set THRESH_PROP=1
% if you are already feeding in a giant-75 binary matrix.
%
% Results are saved to OUT_DIR (env var). The canonical Slurm wrappers
% in scripts/slurm/2_pip_converge_*.sh set OUT_DIR to
%   $NETPIP_ROOT/results/pip_convergence/{avg_giant75|per_subject_giant75}.
% ================================================================
...
if isempty(OUT_DIR)
    OUT_DIR = fullfile(PIP_ROOT, 'pip_convergence_output');
end
