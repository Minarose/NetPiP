...
%   vs PiP removal order from per_subject_pip2d_order_matlab_noheader.csv
...
if ~isfile(pipCsv)
    error('Missing PiP order CSV:\n%s\nRun scripts/6_export_pip_order.py in batch mode first.', pipCsv);
end
