#!/usr/bin/env python3
"""
Per-subject giant-component thresholding (same rule as make_avg_psi_giantcomp_nonexcluded.py).
...
def _load_giant_helpers():
    """Reuse helpers from make_avg_psi_giantcomp_nonexcluded.py (same file dir)."""
    path = _REPO / "make_avg_psi_giantcomp_nonexcluded.py"
