% validate_pip_cluster_drives_percolation_avg_giant75.m
% -------------------------------------------------------------------------
...
avgPipOrderCsv = fullfile(repoRoot, 'analysis', 'giant_component_avg_nonexcluded', ...
    'results', 'AVG_giant75_PiP_2d_label_order_matlab.csv');
clusterCsv = fullfile(repoRoot, 'figures', '5percthresh_analysis', ...
    'pip_avg_cluster_giant_nonexcluded', ...
