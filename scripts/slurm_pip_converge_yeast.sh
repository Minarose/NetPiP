#!/bin/bash
#SBATCH --job-name=pipConvYeast
#SBATCH --cpus-per-task=30
#SBATCH --mem=250G
#SBATCH --time=24:00:00
#SBATCH --output=logs/conv_yeast_%j.out
#SBATCH --error=logs/conv_yeast_%j.err
...
export SUBJECT_FILE=yeastPPI_LCC.mat
...
export OUT_DIR=$NETPIP_ROOT/results/networks_yeast
