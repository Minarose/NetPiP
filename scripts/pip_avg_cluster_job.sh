#!/bin/bash
#SBATCH --job-name=pipAvgCluster
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=logs/pip_avg_cluster_%j.out
#SBATCH --error=logs/pip_avg_cluster_%j.err
...
python3 "$NETPIP_ROOT/scripts/plot_avg_cluster.py" \
  ...
  --out-dir "$NETPIP_ROOT/figures/pip_avg_cluster"
