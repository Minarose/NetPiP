#!/bin/bash
#SBATCH --job-name=pipConsensus5pct
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=logs/pip_consensus_5pct_%j.out
#SBATCH --error=logs/pip_consensus_5pct_%j.err
...
python3 "$NETPIP_ROOT/scripts/pip_consensus_cluster.py" \
  ...
  --out-results "$NETPIP_ROOT/results/consensus_5pct" \
