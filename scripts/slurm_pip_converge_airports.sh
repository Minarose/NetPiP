#!/bin/bash
#SBATCH --job-name=pipConvAirports
#SBATCH --cpus-per-task=30
#SBATCH --mem=250G
#SBATCH --time=24:00:00
#SBATCH --output=logs/conv_airports_%j.out
#SBATCH --error=logs/conv_airports_%j.err
...
singularity exec \
  ...
  --env HW_RANGE_TOL=$HW_RANGE_TOL \
  --env HW_SLOPE_TOL=$HW_SLOPE_TOL \
  --env PLATEAU_WINDOW=$PLATEAU_WINDOW \
