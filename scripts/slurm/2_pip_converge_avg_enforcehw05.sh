#!/bin/bash
#SBATCH --job-name=pipConvAvgGiantNEhw05
#SBATCH --cpus-per-task=30
#SBATCH --mem=250G
#SBATCH --time=70:00:00
#SBATCH --output=logs/conv_giant_avg_nonexcluded_enforcehw05_%j.out
#SBATCH --error=logs/conv_giant_avg_nonexcluded_enforcehw05_%j.err
...
export ENFORCE_HW95=1
export BASE_SEED=12345
export THRESH_PROP=1.0
export OUT_DIR=$NETPIP_ROOT/results/pip_convergence/avg_giant75_enforcehw05
